...
public class ReplyListData {
	...
	private List<Map<String, UserInfoData>> __U; // 用户数据
	private List<Map<String, ReplyData>> __R; // 帖子数据
	...
	public List<Map<String, UserInfoData>> get__U() {
		return __U;
	}

	public void set__U(List<Map<String, UserInfoData>> __U) {
		this.__U = __U;
	}

	public List<Map<String, ReplyData>> get__R() {
		return __R;
	}

	public void set__R(List<Map<String, ReplyData>> __R) {
		this.__R = __R;
	}
